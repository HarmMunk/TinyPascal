...
140 OPEN"R",#2,PLN$:FIELD#2,1 AS OUT.BYTE$:AC.PI=&H100:REM AC.PI IS THE 8080-CODE PROGRAM INDEX. TRANSLATED CODE STARTS AT 0100H IN CP/M
...
6010 GOSUB 9050:WHILE CO1<>255 OR CO2<>255:GOSUB 6100:GOSUB 6200:PC.PI=PC.PI+1:GOSUB 9050:WEND
6020 IF DEBUG>0 THEN PRINT" Done translating"
6030 RETURN

6100 IF LABEL[LAB.INDX,0]=PC.PI THEN LABEL[LAB.INDX,1]=AC.PI:LAB.INDX=LAB.INDX+1:IF DEBUG>1 THEN PRINT" HIT,";:REM STORE THE CODE INDEX OF THE LABEL
...
9010 WHILE CO1<>255 OR CO2<>255:GOSUB 9100:PC.PI=PC.PI+1:GOSUB 9050:WEND:MAX.PC.PI=PC.PI
...
9030 WHILE CO1<>255 OR CO2<>255:GOSUB 9150:PC.PI=PC.PI+1:GOSUB 9050:WEND:IF N.REF<>REF.INDX THEN PRINT"Error: missed a reference!":STOP
